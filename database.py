...
request_json = {'transaction_id': 'aab7fe07-9433-457b-8ac7-8793a804196c', 'event': 'match_status_finished',
                ...
                'payload': {'id': '1-f76d48b9-70b1-4c1d-8a2d-b7e555aea199', 'organizer_id': 'faceit', 'region': 'EU',
                            'game': 'csgo', 'version': 39,
                            'entity': {'id': '42e160fc-2651-4fa5-9a9b-829199e27adb', 'name': 'CS:GO 5v5',
                                       'type': 'matchmaking'},
                            'teams': [
                                {'id': 'eebcf20d-1332-466f-b132-57011312cc23', 'name': 'team_lost1769-', 'type': '',
                                 ...
                                 'roster': [{'id': 'fd440a46-2164-41e1-b965-5473163d49c2', 'nickname': 'FanteN-',
                                             ...
                                             'game_id': '76561198118829978', 'game_name': 'Cut The Air',
                                             'game_skill_level': 10, 'membership': '',
                                            ...
                                            {'id': '738a2f85-c60e-40c6-a944-5d0add94f041', 'nickname': 'otus',
                                             ...
                                             'game_id': '76561199062338256', 'game_name': '< blank >',
                                             'game_skill_level': 10, 'membership': '',
                                             'anticheat_required': True},
                                            {'id': 'eebcf20d-1332-466f-b132-57011312cc23', 'nickname': 'lost1769-',
                                             'avatar': 'https://distribution.faceit-cdn.net/images/e3d3cc7a-e406-4e9d-9fc6-8a8f3c99bd98.jpeg',
                                             'game_id': '76561199199828610', 'game_name': 'MYSTXRIVL',
                                             'game_skill_level': 10,
                                            ...
                                            {'id': '5440b697-1c14-4222-9a6c-85ac9b89a41f', 'nickname': 'Sarnecki',
                                             ...
                                             'game_id': '76561198049585109', 'game_name': '*Sarnecki|♥Karolina',
                                             'game_skill_level': 10,
                                             'membership': '', 'anticheat_required': True},
                                            {'id': '01007cac-59ab-476f-b34d-72995818f043', 'nickname': 'meyerowitz',
                                             ...
                                             'game_id': '76561197997513588', 'game_name': 'hundertwasser',
                                             'game_skill_level': 10,
                                ...
                                {'id': 'c3498b55-97dc-4ae6-9297-0e0045ddaa3a', 'name': 'team_mpd-', 'type': '',
                                 ...
                                 'roster': [{'id': '278790a2-1f08-4350-bd96-427f7dcc8722', 'nickname': '-NAPAD',
                                            ...
                                            {'id': '0c5783e3-52eb-4c2b-b81d-93ee4805b8d5', 'nickname': 'BAKAAAAAA-',
                                             ...
                                             'game_id': '76561198328266530', 'game_name': 'bakaMASH-',
                                             'game_skill_level': 10,
                                             'membership': '', 'anticheat_required': True},
                                            ...
                                            {'id': '6840cd9e-4062-4a7f-90eb-946290a61680', 'nickname': 'RayderT',
                                             ...
                                             'game_id': '76561198036485109', 'game_name': 'Rayder',
                                             'game_skill_level': 10, 'membership': '',
                                             'anticheat_required': True},
                                            {'id': 'c3498b55-97dc-4ae6-9297-0e0045ddaa3a', 'nickname': 'mpd-',
                                             'avatar': 'https://distribution.faceit-cdn.net/images/14de5b23-ef40-49a5-9889-77152d645c53.jpeg',
                                             'game_id': '76561198877437783', 'game_name': 'morto por dentro',
                                             'game_skill_level': 10,
                                             'membership': '', 'anticheat_required': True}], 'substitutions': 0,
                                 'substitutes': None}],
                            'created_at': '2021-11-22T18:08:25Z', 'updated_at': '2021-11-22T18:45:43Z',
                            'started_at': '2021-11-22T18:14:57Z', 'finished_at': '2021-11-22T18:45:43Z'}}
stats = {'rounds': [{'best_of': '2', 'competition_id': None, 'game_id': 'csgo', 'game_mode': '5v5',
                     ...
                     'round_stats': {'Score': '22 / 18', 'Winner': 'ebe8d675-f5b9-49e5-971a-bf846865a7e9',
                                     'Rounds': '40', 'Map': 'de_train', 'Region': 'EU'},
                     'teams': [{'team_id': 'ebe8d675-f5b9-49e5-971a-bf846865a7e9', 'premade': False,
                                'team_stats': {'Second Half Score': '8', 'Team': 'team_KungleBee', 'Team Win': '1',
                                               'Overtime score': '7', 'Team Headshots': '10.6', 'Final Score': '22',
                                               'First Half Score': '7'},
                                'players': [{'player_id': '1e5a3812-12b6-436e-aab7-7d1bc19f215e', 'nickname': 'Jak3yy',
                                            ...
                                            {'player_id': '4a5660d6-e564-4e32-a96d-34b98c1877d7', 'nickname': 'Banelor',
                                             'player_stats': {'MVPs': '1', 'Headshots %': '25', 'Kills': '16',
                                                              ...
                                                              'Quadro Kills': '0', 'Triple Kills': '0',
                                                              'K/R Ratio': '0.4'}},
                                            {'player_id': 'a548c810-d5aa-4b72-941a-c0c6e40306f6',
                                             'nickname': 'KungleBee',
                                             'player_stats': {'K/R Ratio': '1', 'Result': '1', 'Penta Kills': '0',
                                                              'Kills': '40', 'Triple Kills': '5', 'Assists': '5',
                                                              'K/D Ratio': '1.48', 'Quadro Kills': '0',
                                                              'Headshots': '8',
                               ...
                               {'team_id': 'a549dacf-e548-4060-ab66-30d33a23f9a5', 'premade': False, 'team_stats':
                                   {'First Half Score': '8', 'Second Half Score': '7', 'Team Win': '0',
                                    ...
                                    'Final Score': '18'},
                                'players': [{'player_id': '18e2a663-9e20-4db9-8b29-3c3cbdff30ac',
                                             'nickname': 'NoAim_BLR',
                                             'player_stats': {
                                            ...
                                            {'player_id': '8cbb0b36-4c6b-4ebd-a92b-829234016626',
                                             'nickname': 'TV_Hawk_BLR', 'player_stats':
                                                 {'K/R Ratio': '0.7', 'Triple Kills': '1',
                                                  ...
                                                  'MVPs': '5', 'Assists': '5', 'Penta Kills': '0',
                                                  'Headshots %': '32'}},
                                            {'player_id': 'bb9472c5-4c0b-4f91-b6ff-4101d210bdbd', 'nickname': 'gorkit',
                                             'player_stats':
                                                 {'Quadro Kills': '1', 'MVPs': '4', 'Kills': '32', 'K/D Ratio': '1.1',
                                                  'Assists': '8',
                                                  'Result': '0', 'Triple Kills': '2', 'Deaths': '29',
                                                  'K/R Ratio': '0.8',
                                                  'Headshots %': '25', 'Headshots': '8', 'Penta Kills': '0'}},
                                            {'player_id': 'e1cddcbb-afdc-4e8e-abf2-eea5638f0363', 'nickname': 'DeLPix',
                                             'player_stats': {'Kills': '20', 'Assists': '1', 'Result': '0',
                                                              'K/R Ratio': '0.5',
                                                              'Triple Kills': '0', 'Penta Kills': '0',
                                                              'Quadro Kills': '0', 'K/D Ratio': '0.69',
                                                              'MVPs': '3', 'Headshots %': '25', 'Headshots': '5',
                                                              'Deaths': '29'}}]}]}]}
