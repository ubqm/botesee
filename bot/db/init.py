...
from env_variables import DB_HOST, DB_NAME, DB_PASSWORD, DB_PORT, DB_USER
from tortoise import Tortoise, run_async
from tortoise.expressions import Subquery

from bot.db.models_tortoise import Elo, Player
...
async def get_elo_by_player():
    napad_matches = Subquery(Elo.filter(player=NAPAD).values_list("match_id", flat=True))
